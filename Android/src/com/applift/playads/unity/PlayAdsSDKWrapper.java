...
public class PlayAdsSDKWrapper 
{
	...
	public static void PlayAdsSDKStart(final String appId,
			final String appSecret, final String instanceName) {
	...
	public static void PlayAdsSDKGetVersion() {
		Runnable r = new Runnable() {
			@Override
			public void run() {
				callback(CALLBACK_SDK_VERSION, PlayAdsConstants.VERSION);
			}
		};
		runOnUIThread(r);
	}
